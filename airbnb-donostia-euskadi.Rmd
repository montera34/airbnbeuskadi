...
donostia_simple = listings_simple[city=="Donostia",] 
bilbao_simple = listings_simple[city=="Bilbao",]
vitoria_simple = listings_simple[city=="Vitoria-Gasteiz",]
...
write.table(bilbao, "data/bilbao.csv", sep=",",row.names=FALSE)
write.table(bilbao_simple, "data/bilbao_simple.csv", sep=",",row.names=FALSE)

write.table(vitoria, "data/vitoria.csv", sep=",",row.names=FALSE)
write.table(vitoria_simple, "data/vitoria_simple.csv", sep=",",row.names=FALSE) 
